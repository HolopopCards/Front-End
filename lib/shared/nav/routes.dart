...
final Map<String, Widget Function(BuildContext)> routes = {
  ...
  CreateRecordVideo.route(): (context) => const CreateRecordVideo(),
  CreateUpload.route():      (context) => const CreateUpload(),
  CreateMarketplace.route(): (context) => const CreateMarketplace(),
